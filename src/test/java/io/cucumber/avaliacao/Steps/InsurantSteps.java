...
public class InsurantSteps extends Configuracao {
        ...
        public void que_digito_o_nome() {
            InsurantPage.campoNome(browser).sendKeys("Kero");
        }
    
        @Dado("digito o sobrenome")
        public void digito_o_sobrenome(){
            InsurantPage.campoSobrenome(browser).sendKeys("Gomes");
        }
        ...
        public void escolho_um_genero() throws InterruptedException {
            WebElement element = InsurantPage.campoGenero(browser);
        ...
        public void digito_o_endereco() {
            InsurantPage.campoEndereco(browser).sendKeys("rua do desespero");
        }
        ...
        public void digito_um_CEP() {
            InsurantPage.campoCep(browser).sendKeys("44700582");
        }
    
        @Dado("digito cidade")
        public void digito_cidade() {
            InsurantPage.campoCidade(browser).sendKeys("Londres");
        }
        ...
        public void insiro_o_local_na_rede_de_internet() {
            InsurantPage.campoWebsite(browser).sendKeys("https://github.com/kerollainy");
        }
